...
Future<List<Serie>> getSeries(BuildContext context) async
{ 
  ...
  List<Serie> listaSeries = new List<Serie>(); //Lista de consecutivos
    ...
    if(conexion == true)
    {
      ...
      respuestaServidor = await get('http://mivoip.net/api/consultaSeries.php');
